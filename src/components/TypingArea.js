...
class TypingArea extends React.Component {
  ...
  componentDidMount() {
    this.dHolder(
      "typing-field",
      ["Welcome to Typing Test by Antor", "Click Here and Start Typing!"],
      150
    );
  }
  ...
  dHolder = function(id, texts, interval) {
    ...
    function change() {
      const placeholder = texts[index].slice(0, slicer);
    ...
    return (
      <div className={"container-fluid"}>
          ...
          <div className={"col-12"} id={"something"}>
            <div className={""}>
              ...
              <div className={"text-center mt-3"}>
                <input
                  className={"default-sized-text custom-placeholder"}
        ...
        <div id={"credit"} className={""}>
          Made With <span className={"red-text"}>❤</span> by{" "}
          <a target={"blank"} href={"https://github.com/antorkhan"}>
            Antor
          </a>
        </div>
      </div>
